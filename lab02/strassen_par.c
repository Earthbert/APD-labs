...
pthread_barrier_t barrierC11;
pthread_barrier_t barrierC12;
pthread_barrier_t barrierC21;
pthread_barrier_t barrierC22;
...
void *f1(void *args) {
	...
	pthread_barrier_wait(&barrierC11);
	pthread_barrier_wait(&barrierC22);
...
void *f2(void *args) {
	...
	pthread_barrier_wait(&barrierC21);
	pthread_barrier_wait(&barrierC22);
...
void *f3(void *args) {
	...
	pthread_barrier_wait(&barrierC12);
	pthread_barrier_wait(&barrierC22);
...
int main(int argc, char *argv[]) {
	...
	pthread_barrier_init(&barrierC11, NULL, 4);
	pthread_barrier_init(&barrierC12, NULL, 2);
	pthread_barrier_init(&barrierC21, NULL, 2);
	pthread_barrier_init(&barrierC22, NULL, 4);
